...
import { ERROR_URI_PREFIX, PREFIXES, JOBS_GRAPH, ERROR_TYPE, DELTA_ERROR_TYPE } from '../env-config.js';
...
export async function batchedUpdate( nTriples, targetGraph, operation = 'INSERT', sleep = 1000, batch = 100){
...
export async function batchedQuery( subjectPredicateObjectQuery, batch = 100, orderByStr = 'ORDER BY ?subject ?predicate ?object'){
...
export function diffNTriples(target, source) {
